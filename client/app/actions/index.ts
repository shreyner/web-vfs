...
import {ADD_FOLDER, ADD_FILE, SELECT_ITEM, DELETE_ITEM, SAVE_FILE} from "../constants/index";
...
export type TSaveChangeFile =  (fileItem: FileModel, name: string, body: string) => void;
...
export const saveChangeFile = createAction<any, FileModel, string, string>(
    SAVE_FILE,
    (fileItem: FileModel, name: string, body: string) => ({fileItem: fileItem, name: name, body: body})
);